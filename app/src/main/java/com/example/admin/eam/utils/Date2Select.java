...
public class Date2Select {
    ...
    public Date2Select(Context context, TextView textView) {
    ...
    private class datelistener implements DatePickerDialog.OnDateSetListener {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            if (monthOfYear + 1 < 10) {
                if (dayOfMonth < 10) {
                    sb.append(year + "-" + "0" + (monthOfYear + 1) + "-" + "0" + dayOfMonth);
                } else {
                    sb.append(year + "-" + "0" + (monthOfYear + 1) + "-" + dayOfMonth);
                }
            } else {
                if (dayOfMonth < 10) {
