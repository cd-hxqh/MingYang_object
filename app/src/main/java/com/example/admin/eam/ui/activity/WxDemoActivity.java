...
import com.example.admin.eam.ui.adapter.ImagePickerAdapter;
import com.example.admin.eam.ui.widget.GlideImageLoader;
import com.example.admin.eam.utils.ImageCompressUtils;
...
//                break;
    ...
    private View.OnClickListener submitBtnOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Log.i("图片上传", "imageItems=" + imageItems.size());
