...
public class Udfeedback extends Entity implements Serializable {
    ...
    {
        map.put("FEEDBACKNUM","编号");
        map.put("DESCRIPTION","描述");
        map.put("PROBLEMTYPE","问题类型");
        map.put("EMERGENCY","紧急程度");
        map.put("WORKORDERNUM","关联故障工单号");
        map.put("PROBLEMSITUATION","现场问题及进展情况描述");
        map.put("PRONUM","项目编号");
        map.put("CREATEBY","需求提出人编号");
        map.put("CREATENAME","需求提出人名称");
        map.put("CREATEDATE","提出时间");
        map.put("STATUS","状态");
        map.put("LEADER","支持部门编号");
        map.put("RESPONSETIME","需求完成时间");
        map.put("SOLVEDBY","问题处理人");
        map.put("FOUNDTIME","抵达时间");
        map.put("COMPTIME","完成时间");
        map.put("PROGRESS","解决问题及反馈");
        map.put("ISSTOP","是否解决");
        map.put("REMARK","说明");
        map.put("BRANCH","所属中心");
        map.put("DEPT1","提出人部门");
        map.put("DEPT2","支持部门名称");
        map.put("DEPT3","解决人所属部门");
        map.put("PRODESC","项目描述");
        map.put("PHONE1","负责人电话");
        map.put("PHONE2","提出人电话");
        map.put("PHONE3","处理人联系电话");
        map.put("PRORES","项目负责人");
        map.put("SOLVENAME","问题处理人");
        map.put("PROSTAGE","项目阶段");
        return map;
    }
