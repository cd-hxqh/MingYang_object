...
//        delete.setOnClickListener(deleteOnClickListener);
    ...
    private void showPopupWindow(View view) {
        ...
        View contentView = LayoutInflater.from(WoactivityDetailsActivity_TP.this).inflate(
    ...
    private View.OnClickListener uploadLinearLayoutOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            popupWindow.dismiss();
            Intent intent = new Intent(WoactivityDetailsActivity_TP.this, PhotoActivity.class);
