...
public class Udcarfuelcharge_Addactivity extends BaseActivity {
    ...
    private Udcarfuelcharge capsulation() {
        ...
        udcarfuelcharge.setNOWPROJECT(pronum);
    ...
    private void startAsyncTask() {
        ...
        Log.i("", "updataInfo=" + updataInfo);
        final String finalUpdataInfo = updataInfo;
        new AsyncTask<String, String, WebResult>() {
            @Override
            protected WebResult doInBackground(String... strings) {
                WebResult reviseresult = AndroidClientService.InsertWO(Udcarfuelcharge_Addactivity.this,
