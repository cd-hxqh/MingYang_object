package com.example.admin.eam.webserviceclient;
...
//    }
    ...
    public static String checkWFPRequired(Context context,String appId,String objectName,String status)
    {
        SoapSerializationEnvelope soapEnvelope = new SoapSerializationEnvelope(SoapEnvelope.VER11);
        soapEnvelope.implicitTypes = true;
        soapEnvelope.dotNet = true;
        SoapObject soapReq = new SoapObject(NAMESPACE, "mobileservicecheckWFPRequired");

        soapReq.addProperty("appId", appId);
        soapReq.addProperty("objectName", objectName);
        soapReq.addProperty("wfpStatus", status);
