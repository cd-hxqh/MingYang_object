package com.example.admin.mingyang_object.ui;
...
//            testproText.setText(udpro.t);
    ...
    private View.OnClickListener udfandetailsLinearOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent intent = new Intent(Udcardrivelog_Detailactivity.this, Udfandetails_ListActivity.class);
    ...
    private View.OnClickListener personLinearOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent intent = new Intent(Udcardrivelog_Detailactivity.this, UdPerson_ListActivity.class);
            intent.putExtra("pronum", udpro.getPRONUM());
            startActivityForResult(intent, 0);
            popupWindow.dismiss();
    ...
    private View.OnClickListener udvehicleLinearOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent intent = new Intent(Udcardrivelog_Detailactivity.this, Ududvehicle_ListActivity.class);
            intent.putExtra("pronum", udpro.getPRONUM());
            startActivityForResult(intent, 0);
            popupWindow.dismiss();
